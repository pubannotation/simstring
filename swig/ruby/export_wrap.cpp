...
/*@SWIG:/opt/local/share/swig/2.0.11/ruby/rubyprimtypes.swg,19,%ruby_aux_method@*/
...
SWIGINTERN VALUE
_wrap_reader_check(int argc, VALUE *argv, VALUE self) {
  reader *arg1 = (reader *) 0 ;
  char *arg2 = (char *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_reader, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "reader *","check", 1, self )); 
  }
  arg1 = reinterpret_cast< reader * >(argp1);
  res2 = SWIG_AsCharPtrAndSize(argv[0], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "char const *","check", 2, argv[0] ));
  }
  arg2 = reinterpret_cast< char * >(buf2);
  {
    try {
...
SWIGEXPORT void Init_simstring(void) {
  ...
  rb_define_method(SwigClassReader.klass, "check", VALUEFUNC(_wrap_reader_check), -1);
